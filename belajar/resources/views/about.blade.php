...
<body>
  <div class="navbar">
    <div class="sticky-top justify-content-between" style="z-index: 1; position:fixed; width:100%;">
      <header class="d-flex flex-wrap justify-content-between py-2 border-bottom">
        ...
        <ul class=" nav nav-pills nav-fill gap-1 p-1 small bg-dark rounded-5 shadow-sm mx-auto text-bold align-items-center text-center" role="tablist"
         style="--bs-nav-link-color: var(--bs-white); --bs-nav-pills-link-active-color: var(--bs-primary); --bs-nav-pills-link-active-bg: var(--bs-white);">
          ...
          <li class="nav-item">
            <form action="/film">
            <button class="nav-link rounded-5" fill="current color" aria-selected="true" data-bs-toggle="tab">Film</button>
            </form>
          </li>
          <li class="nav-item">
          ...
          <li class="nav-item">
            <form action="/about">
            <button class="nav-link active rounded-5" fill="current color" aria-selected="true" data-bs-toggle="tab">About</button>
            </form>
          </li>
        </ul>
...
<img class="d-block mx-auto mb-4" src="img/kikii.gif" alt="" width="100%" style="margin-top: 3%">
<div class="container">
...
<div class="row">
  ...
  <div class="wrapper">
    <div class="sidebar bd-dark rounded pb-3">
      <ul class="text-white">
        <li class="text-white">CATEGORY</li>
        <li class="text-white"><a href="#history">History</a></li>
        <li class="text-white"><a href="#nama">Name History</a></li>
        <li><a href="#gaya">Style And Theme</a></li>
        
       </ul>
    </div>
    <div class="main" id="about">
      <h1 class="display-5 fw-bold" style="margin-top: -3%">About Studio Ghibli</h1>
      <div class="justify-content">
        <p>{{$items->penjelasanumum}}</p>
      </div>
    </div>
  </div>
    ...
    <hr id="history">
    <div class="col-4 col-sm-8 col-lg-7"  >
    <h1>History Studio Ghibli</h1>
      <div>
       <p>{{$items->sejarah}}</p>
      </div>
    </div>
    ...
    <div class="col-lg-6 py-3">
      <h1>Why Ghibli Studio?</h1>
      <div>
       <p>{{$items->sejarahnama}}</p>
      </div>
    </div>
</div>
<div id="gaya">
    ...
    <div class="row row-cols-1 row-cols-md-3 g-4">
      <div class="col">
          <img src="img/foff.gif" class="card-img-top rounded" alt="...">
      </div>
      <div class="col">
          <img src="img/ponyo.gif" class="card-img-top rounded" alt="...">
      </div>
      <div class="col">
          <img src="img/howl-.gif" class="card-img-top rounded" alt="...">
      </div>
</div>
